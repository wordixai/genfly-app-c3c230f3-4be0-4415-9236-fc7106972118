    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-r from-yellow-300 via-pink-300 to-orange-300 pop-dots">
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="handwritten text-5xl font-bold text-gray-800 mb-4 transform -rotate-0.5">
              🔥 热门商品 🔥
            </h2>
      ...
      <section className="py-20 comic-bg">
        <div className="container mx-auto px-6 text-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="handwritten text-4xl font-bold text-gray-800 mb-6 transform rotate-0.5">
              加入POP SHOP大家庭！
            </h3>
      ...
      <footer className="bg-gradient-to-r from-pink-600 to-orange-600 text-white py-12 pop-dots-pink">
        <div className="container mx-auto px-6 text-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h4 className="handwritten text-3xl font-bold mb-4 transform -rotate-0.5">
              POP SHOP
            </h4>
